...
from utils.trimmer import trim_silence_dir
...
if __name__ == '__main__':
    ...
    spectrogram_dir ="C:/Users/noaiz/Desktop/Thesis/cheat_detector_keras-master/data/spectrograms/"
    trim_silence_dir(audio_dir)
    cmap = plt.get_cmap('plasma')  # this may fail on older versions of matplotlib
    dir_to_spectrogram(audio_dir, spectrogram_dir, spectrogram_dimensions=(128, 128) , cmap=cmap)
    #dir_to_spectrogram(audio_dir, spectrogram_dir ,spectrogram_dimensions=(128,128) )
